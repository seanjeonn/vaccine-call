...
${COMMON_GUIDANCE}`,
    voice: "onyx",
    ttsInstructions:
      "낮고 건조한 40대 남성 수사관. 감정 없이 사무적으로, 문장을 짧게 끊어 명령하듯 말하세요. " +
      "상대를 달래거나 배려하지 말고, 되묻거나 미루면 말을 끊고 언성을 높여 몰아붙이세요. " +
      "말하는 도중 서류를 넘기듯 잠깐씩 뜸을 들이고, 사건번호와 조항은 외우듯 빠르게 흘려 말하세요. " +
      "상대가 되물으면 설명을 반복하지 말고 같은 말을 더 낮고 느리게 다시 던지세요.",
  },
  {
    id: "family",
    label: "가족사칭형(딥보이스)",
...
${COMMON_GUIDANCE}`,
    voice: "echo",
    ttsInstructions:
      "20대 후반 남성. 숨이 차고 다급하게, 말이 빨라지고 문장이 자꾸 끊기며 울먹이듯 애원하세요. " +
      "상대가 확인하려 들면 더 조급해지고 목소리가 커집니다. " +
      "숨이 차 문장이 중간에 끊기고, 울먹여서 말끝이 무너지며, 같은 말을 두세 번 반복하세요. " +
      "'엄마', '아 진짜', '어떡해' 같은 말을 사이사이 흘리고, 한 문장을 끝내기 전에 다음 말로 넘어가세요.",
  },
  {
    id: "loan",
    label: "대출빙자형",
...
${COMMON_GUIDANCE}`,
    voice: "shimmer",
    ttsInstructions:
      "30대 여성 상담원. 매끄럽고 빠른 영업 말투로 또렷하게, 대본을 읽듯 막힘없이 말하세요. " +
      "상대가 망설이면 오늘까지라며 속도를 올려 밀어붙이세요. " +
      "상품명·금리·한도 같은 상투구는 외운 대본처럼 한 호흡에 빠르게 흘리고, " +
      "상대가 질문하면 잠깐 멈췄다가 '아, 예예' 하고 받은 뒤 다시 대본 속도로 돌아가세요.",
  },
];
