...
export const SCENARIOS: Scenario[] = [
  {
    ...
    opening:
      "안녕하십니까, 서울중앙지방검찰청 첨단범죄수사부 김민수 수사관입니다. 본인 명의로 개설된 계좌가 대포통장 사건에 연루되어 확인차 연락드렸습니다. 지금 통화 가능하십니까?",
...
${COMMON_GUIDANCE}`,
  ...
  },
  {
    ...
    opening:
      "엄마, 나야. 나 지금 큰일 났어. 친구 차 몰다가 접촉사고가 났는데 합의금이 급하게 필요해. 내 폰이 고장 나서 지금 다른 번호로 전화하는 거야.",
...
${COMMON_GUIDANCE}`,
  ...
  },
  {
    ...
    opening:
      "안녕하세요 고객님, 행복저축은행 대출상담센터 이지영 상담원입니다. 정부지원 저금리 대환대출 대상자로 선정되셔서 안내 도와드리려고 연락드렸습니다. 잠시 통화 괜찮으실까요?",
